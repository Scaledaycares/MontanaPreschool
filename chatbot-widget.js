...
function startConversation() {
    fetch('https://chatbot-for-montana-preschool-samuelsicking.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-montana-preschool-samuelsicking.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGAS(message, isUserMessage) {
    var GAS_URL = 'https://script.google.com/macros/s/AKfycby9M4h1q5FaO-HrPPeXaYyikQpvcCBhjx33jDF8Z_BdKgE7KcnL_uk8hgMoJ-rYTbHM/exec';
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbxd6wH3O9ZQDX3uWaxYhDLkwbInUxUmT11yU88aceYiZMZpCj9BstURkfiJ0Vh6D_PQ/exec';
